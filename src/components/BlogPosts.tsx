		...
		<div className='mt-16'>
			<div className='flex justify-between max-[720px]:flex-col-reverse max-[720px]:gap-y-4'>
				...
				<div className='relative'>
					<input
						className='bg-mwasi border border-[#EAEAEA33] rounded-full px-[6px] py-[6px] w-[400px] h-[42.57px] max-[720px]:w-full [@media(min-width:600px)]:h-[45px] flex items-center justify-between hover:cursor-pointer'
						// onChange={}
					/>
