...
**Step 1** - Open your terminal and connect it to your desired Postgres database. Follow our [guide](/docs/getting-started/postgres_guides/how-to-connect-to-postgres) to see the whole process.
...
<Image src={PostgresUser} width="600" alt="PostgresUser" />
...
We recommend you check out our other [Postgres guides](/docs) and visit our [blog section](https://tembo.io/blog/) to stay updated on our upcoming projects and new additions.
