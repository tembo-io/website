...
| ----------------------------------------------------- | --------------------------- |
| [Data Warehouse](https://tembo.io/docs/product/stacks/analytical/data-warehouse)                    | Snowflake, Bigquery         |
| [Geospatial](https://tembo.io/docs/product/stacks/analytical/geospatial)                           | ESRI, Oracle                |
| [OLTP](https://tembo.io/docs/product/stacks/transactional/oltp)                                       | Amazon RDS                  |
| [OLAP](https://tembo.io/docs/product/stacks/analytical/olap)                                       | Snowflake, Bigquery         |
| [Machine Learning](https://tembo.io/docs/product/stacks/ai/machine-learning)               | MindsDB                     |
| [Message Queue](https://tembo.io/docs/product/stacks/transactional/message-queue)                     | Amazon SQS, RabbitMQ, Redis |
| [Mongo Alternative on Postgres](https://tembo.io/docs/product/stacks/transactional/mongo-alternative) | MongoDB                     |
| [RAG](https://tembo.io/docs/product/stacks/ai/rag)                                         | LangChain                   |
| [Standard](https://tembo.io/docs/product/stacks/transactional/standard)                               | Amazon RDS                  |
| [Vector DB](https://tembo.io/docs/product/stacks/ai/vectordb)                             | Pinecone, Weaviate          |
| [Time Series](https://tembo.io/docs/product/stacks/analytical/timeseries)                          | InfluxDB, TimescaleDB       |
...
<Callout variant='info'>
	...
	database on our [blog](https://tembo.io/blog/tembo-stacks-intro)!
</Callout>
