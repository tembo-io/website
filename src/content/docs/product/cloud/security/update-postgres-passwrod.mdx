...
This guide provides detailed instructions on how to update the PostgreSQL password for your instances managed through Tembo Cloud. Password updates can be performed directly through the Tembo Cloud interface or programmatically via our API.
...
For integration into your system management workflows, you can update the password using the API.
