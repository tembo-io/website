...
<Callout variant='info'>
	Coming soon: Point-In-Time Recovery (PITR) via the [Tembo Cloud
	UI](https://cloud.tembo.io)
</Callout>
...
For more information to restore from an existing instance, please see the [Tembo Cloud Platform API documentation](https://api.tembo.io/swagger-ui/).
