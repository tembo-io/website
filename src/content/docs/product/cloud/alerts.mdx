...
Tembo picks default values for these parameters based on your instance size and Stack. You can review and alter them in the instance's [Postgres Configuration](/docs/product/cloud/configuration-and-management/postgres-configuration) settings.
...
Postgres versions 15 and above will try to prefetch blocks that appear in the replication stream to reduce this effect.
</Callout>
...
Follow the [logging](/docs/product/cloud/logs) documentation to setup Grafana to view your logs.  Once you have the new Data Source setup you will be able to search for logs using your `instance_id`

[!grafana-logging-datasource](/docs/product/cloud/images/log-grafana.png)
