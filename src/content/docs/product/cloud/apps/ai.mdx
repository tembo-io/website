...
Tembo AI is a managed hosting service for Large Language Models with an [OpenAI compliant API](https://platform.openai.com/docs/api-reference/chat/create).
 It hosts open source models on Tembo infrastructure which provides reduced network latency and enhanced privacy.

In Tembo Cloud, LLMs are a shared service that runs within the Tembo Cloud data-plane.
...
You can enable Tembo AI by navigating to "Apps", then "Embeddings". Click "Activate" to enable Tembo AI.
