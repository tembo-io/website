  ...
  temboUI:
    ...
    env:
      ...
      - name: NEXT_PUBLIC_API_BASE_URL
        value: "https://api.tembo.mydomain.com/api"
      - name: NEXT_PUBLIC_API_BASE_URL_V1
        value: "https://api.tembo.mydomain.com/api/v1"
      - name: NEXT_PUBLIC_INTERCOM_APP_ID
        value: "xxxxixeb"
      - name: NEXT_PUBLIC_METRICS_BASE_URL
        value: "tembo.mydomain.com"
...
The base domain should be the same one created in Step 2. Please get in support with Tembo if you need any help obtaining these values.
