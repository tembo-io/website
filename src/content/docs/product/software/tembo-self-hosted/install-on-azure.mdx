...
## Step 7: Add `ipAllowList` to the Traefik's CRD
...
## Step 8: Configure permissions for the CSI driver
...
## Step 9: Create the `premium-ssd-enc` StorageClass
...
## Step 11: Deploy a Tembo Postgres instance through mahout
