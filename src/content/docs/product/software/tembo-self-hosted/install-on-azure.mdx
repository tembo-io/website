...
## Step 5: Configure permissions for the CSI driver
...
## Step 6: Create the `premium-ssd-enc` StorageClass
...
## Step 7: Install the Tembo Self Hosted Helm chart
...
### Step 8.1: Set up a DNS Zone in Azure Portal
...
### Step 8.2: Identify Traefik's Load Balancer external IP
...
### Step 8.3: Create an `A` record to re-route traffic to Traefik's Load Balancer
...
## Step 9: Add `ipAllowList` to the Traefik's CRD
