...
<Callout variant='tip'>
	While the majority of our customers use our fully-managed service <a href="https://cloud.tembo.io">Tembo Cloud</a>,
...
Tembo Self Hosted is our Tembo Cloud software, packaged for you to rus in your own Kubernetes cluster. It
allows you to benefit from the same features as Tembo Cloud, but with the added control and security of running
the software in a controlled environment.

Tembo Self Hosted is composed of the same components as Tembo Cloud, but packaged and distributed in a way that allows for
...
Questions? [Schedule a meeting with our CEO, Ry Walker](https://cal.com/rywalker/virtual-meeting?duration=30&month=2025-01&date=2025-01-03) to get
answers :)
