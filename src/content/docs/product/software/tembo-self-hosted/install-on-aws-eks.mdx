...
Check the external IP of the created Traefik load balancer:

```shell
kubectl get svc -n traefik
NAME      TYPE           CLUSTER-IP      EXTERNAL-IP                                                                     PORT(S)                                     AGE
traefik   LoadBalancer   10.100.66.129   a889290af81c347fcaec71f12654ebcb-586234047e8a89c2.elb.us-east-1.amazonaws.com   5432:31713/TCP,80:30470/TCP,443:32484/TCP   31m
```
...
## Step 9: Check the status of the installation
