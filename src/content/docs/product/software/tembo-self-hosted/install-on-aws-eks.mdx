...
```shell
bash <(curl -s https://raw.githubusercontent.com/tembo-io/tembo-enterprise/main/scripts/aws/eks-setup.sh)
```
...
## Step 6: Update the StorageClass to allow for volume expansion
...
## Step 8: Check the status of the installation
...
## Step 10: Access the Tembo Self Hosted
