...
Tembo provides support for the installation, configuration, and operation of Tembo Enterprise. Our support team is
available to help you with any Tembo Enterprise issues you may encounter and to provide guidance on best practices for running the
...
We encourage Tembo Enterprise users to upgrade to the latest patch release as soon as possible to benefit from the latest
...
## Try Tembo Enterprise
Interested in trying Tembo Enterprise? [Schedule some time with us](https://calendly.com/ian-tembo) to get
started!
