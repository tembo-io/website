...
<Callout variant='info'>
	Make sure to connect your desired Postgres database before executing these
	commands. Check out [our guide to follow the step-by-step
	process](https://tembo.io/docs/postgres_guides/how-to-connect-to-postgres/).
</Callout>
...
<Image src={DisplayingData} width='600' alt='DisplayingData' />
...
<Image src={Operator1} width='600' alt='Operator1' />

```
select info ->> 'name' as names from students;
```

<Image src={Operator2} width='600' alt='Operator2' />
...
<Image src={WhereClause} width='600' alt='WhereClause' />
...
<Image src={JsonEach} width='500' alt='JsonEach' />
...
<Image src={Update} width='900' alt='Update' />
...
<Image src={Nested} width='600' alt='Nested' />
...
Struggling to connect to Postgres on your project? Check out our other [Postgres guides](/docs/getting-started/postgres_guides/all-possible-joins-in-postgres) for more help.
