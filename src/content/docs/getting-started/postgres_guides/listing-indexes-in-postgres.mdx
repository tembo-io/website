...
<Image src={DiCommand} width='600' alt='DiCommand' />
...
<Image src={SqlQuery} width='400' alt='SqlQuery' />

<Callout variant='info'>
	You can run this same command in the pgAdmin tool and it will return the
	same results.
</Callout>
...
Want to expand your knowledge of Postgres? Explore our additional [guides](/docs/getting-started/postgres_guides/all-possible-joins-in-postgres).
