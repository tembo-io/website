...
<Callout variant='info'>
	To connect a terminal with your desired Postgres database to try out every
	join in Postgres, follow our guide to see the whole process, [click
	here](https://tembo.io/docs/postgres_guides/how-to-connect-to-postgres/).
</Callout>
...
<Image src={InnerJoin} width='400' height='100' alt='inner-join' />
...
<Image src={InnerJoinTables} width='800' height='100' alt='inner-join-tables' />
...
<Image
	src={InnerJoinTablesResults}
	width='700'
	height='100'
	alt='inner-join-table-results'
/>
...
<Image src={LeftJoin} width='400' height='100' alt='left-join' />
...
<Image src={LeftJoinTables} width='800' height='100' alt='left-join-tables' />
...
<Image
	src={LeftJoinTablesResults}
	width='800'
	height='100'
	alt='left-join-table-results'
/>
...
<Image src={RightJoin} width='400' height='100' alt='right-join' />
...
<Image
	src={RightJoinTablesResults}
	width='800'
	height='100'
	alt='right-join-tables-results'
/>
...
<Image src={FullOuterJoin} width='400' height='100' alt='full-outer-join' />
...
<Image
	src={FullOuterJoinTablesResults}
	width='700'
	height='100'
	alt='full-outer-join-tables-results'
/>
...
<Image src={CrossJoin} width='400' height='100' alt='cross-join' />
...
<Image src={CrossJoinTables} width='700' height='100' alt='cross-join-tables' />
...
<Image src={SelfJoinTable} width='400' height='100' alt='self-join-tables' />
...
<Image
	src={SelfJoinTablesResults}
	width='700'
	height='100'
	alt='self-join-table-results'
/>
...
You can check out our [guides page](/docs/getting-started/postgres_guides/all-possible-joins-in-postgres) to know more about basic operations you can perform on Postgres.
