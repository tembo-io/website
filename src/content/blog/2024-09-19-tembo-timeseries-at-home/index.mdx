...
The [Tembo Time Series stack](/docs/product/stacks/analytical/timeseries) is now available, but as an author of its [underlying extension](https://github.com/tembo-io/pg_timeseries/), I've struggled with the same problem I hit any time I contribute to a [time-series](CloudWatch) or [database project](Citus): I've spent more time making and testing this tool than I will spend using it.
...
├──────┼────────────────────────────────────────────────────┼────────────────────────────────────────┤
│    0 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    1 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    2 │ sensor.theater_sensor_temperature                  │ sensor.theater_sensor_temperature      │
│    3 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    4 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    5 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    6 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    7 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    8 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│    9 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│   10 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
│   11 │ sensor.theater_sensor_temperature                  │ sensor.main_bedroom_sensor_temperature │
…
└──────┴────────────────────────────────────────────────────┴────────────────────────────────────────┘
```
