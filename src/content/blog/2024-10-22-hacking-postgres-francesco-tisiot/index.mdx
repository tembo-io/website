...
<iframe style={{ position: 'absolute', top:'10px', width: '100%', height: '100%' }} width="100%" height="400" src="https://www.youtube.com/embed/lGncGn8VStk?si=zsxNvZpwAYFwoPI1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen> </iframe>
...
We have more Hacking Postgres episodes scheduled and you can find all previous recordings on our [YouTube](https://www.youtube.com/watch?v=9oKJrtqtu1M&list=PL11N188AYb_Z04oQJgllNEY5m7gCcY8tH), or listen on [Apple](https://podcasts.apple.com/us/podcast/hacking-postgres/id1710401793), or [Spotify](https://open.spotify.com/show/0YrYG1WCCw27Jtwt4dikLp).
