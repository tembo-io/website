...
F
irst I was curious what a day in the life of a Field CTO looks like. Francesco tells me it’s a mix of Developer Relations and what he was doing in his previous career: consulting. Like a CTO that a company "lends" to their customers, a technical advisor understanding their pain points and where potentially Aiven's services make sense. Internally, Francesco translates the problems he sees in the field into solutions.

## On new stuff

Recently they announced Aiven for AlloyDB Omni, which, Francesco explains, for a Postgres user, is Postgres-compatible but it opens the door to features the Google team created. Worked closely with Google to bring AlloyDB Omni to Aiven and to deliver on all major Clouds.
...
Knowing what part of your work you're comfortable with receiving automated updates, and what parts maybe just need to run and shouldn't be interrupted with updates (even if they're slow in comparison to the rest of your system), that is the key to using AI.

## On the opportunities of Oracle

Since joining Aiven, Francesco advocated for Aiven to try and be available in the Oracle Cloud Marketplace, to add another deployment option for customers. Now anyone who's in the Postgres community knows that when someone utters the word "Oracle" it's usually as the clue to a joke. Quite possibly people who read the title of Aiven's press release must have checked the date to see if it wasn't April's fools by any chance. But Francesco says choice is freedom. "Oracle Cloud is not Oracle database anymore. It's an established player, and there was customer demand to go to OCI."

## On the Postgres community

Ry, when he was doing the Hacking Postgres podcast, would always ask his guests about their controversial opinion about Postgres. Francesco went straight for the heart saying that he's not bought into "the whole using Postgres for everything, even painting your kitchen". Of course he would say that, Aiven offers several, more specialized data tools. But: "I am a fan of keeping it simple. If you are able to have decent performance for your workloads with the tool you already know and use, why change". Indeed.
