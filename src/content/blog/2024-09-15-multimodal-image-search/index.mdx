...
Refer to the setup instructions in the project [README](https://github.com/tembo-io/tembo/blob/main/examples/image-search/README.md) and follow the [notebook](https://github.com/tembo-io/tembo/blob/main/examples/image-search/demo.ipynb).
