...
If you'd like to work with Prometheus data from inside of Postgres, you can also look at [prometheus_fdw](https://pgt.dev/extensions/prometheus_fdw) on [GitHub](/blog/monitoring-with-prometheus-fdw), or read about it in the [blog](/blog/monitoring-with-prometheus-fdw).
