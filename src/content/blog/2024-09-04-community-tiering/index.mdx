...
In the final stage, data is rarely accessed but retained for long-term storage and compliance. Object store tiering has evolved as an alternative or complement to traditional data archiving methods. `pg_tier` provides users with bottomless storage and a low cost of data access.
