---
slug: auto-dw
title: 'pg_auto_dw: a postgres extension to generate well-formed data warehouses with AI'
description: We are working on a new Postgres extension, pg_auto_dw, to generate well-formed data warehouses with AI.
authors: [ryw]
