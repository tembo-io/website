---
slug: auto-dw
title: 'pg_auto_dw: a postgres extension to automate the build of data warehouses'
description: We are working on a new Postgres extension, pg_auto_dw, to automate the build of data warehouses.
authors: [ryw]
...
<Callout title='tl;dr' variant='tip'>
     We are working on a new Postgres extension, [pg_auto_dw](https://github.com/tembo-io/pg_auto_dw), to automate the build of data warehouses.
</Callout>

We are dedicated to commercializing and creating Postgres extensions and [Stacks](https://tembo.io/docs/product/stacks/intro-to-stacks) that drive developer efficiency. 
...
I have wanted this badly for years as a dev + data engineer. We aren't sure how this experimend will work out, but kind of fun to start something without certainty of success. 

We've recently partnered with our friend Johnathan Pickard from [Analyzer1](https://www.analyzer1.com/) to iterate with us on this project. With the integration of Large Language Models (LLMs), he will transition his previously built automations to be as fully-automated as possible. And this shift requires a bit of rethink. 
