---
slug: auto-dw
title: 'pg_auto_dw: a Postgres extension to help you build a data warehouse with AI'
description: We are working on a new Postgres extension, pg_auto_dw, to help you build a data warehouse with AI.
authors: [ryw]
