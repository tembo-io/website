...
authors: [nishil]
description: Build a Vector Search-Powered E-commerce Platform with Tembo and Zero API Endpoints (and Next.js)
...
💡 **_Pro tip_:** _The fastest way to follow along is to clone the [repository](https://github.com/tembo-io/tembo-labs/tree/main). However, we'll walk through each vector search related step in detail if you prefer to build from scratch!_
...
4. Configure the OpenAI integration:
