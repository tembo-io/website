...
authors: [floor, steven]
description: |
    Benefit from new Tembo Cloud functionality to rename, pause, and resume instances
tags: [postgres, cloud, pausing, cost]
date: 2024-07-31T09:00
image: './pause-resume.png'
planetPostgres: false
---

We've recently added functionality to [Tembo Cloud](https://cloud.tembo.io/), including the ability to rename and temporarily pause instances, to give you greater control. Let's dive in to learn more about these features!
