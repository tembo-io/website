    ...
    <div className={cx('fixed top-0 w-full z-50 transition duration-100', scrollY > 20 ? 'backdrop-blur-lg safari-blur' : '')} >
      ...
      <Container>
        <nav className={cx('flex justify-between items-center transition-all duration-100', scrollY > 20 ? 'py-3 min-[900px]:py-4' : 'py-8')}>
         ...
         <Button variant='neon' styles='min-[900px]:flex hidden z-100' onClick={() => navigate('https://cloud.tembo.io')}>Try Free</Button>
          <div className='min-[900px]:hidden flex flex-col gap-[2.5px] items-center justify-center bg-neon rounded-full w-[32.57px] h-[32.57px] p-2.5'>
